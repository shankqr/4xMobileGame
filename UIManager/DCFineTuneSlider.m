...
#define FONT_SIZE (8.0f*SCALE_IPAD)
...
- (void)setup
{
    ...
    UIImage *thumbImage = [UIManager.i imageNamedCustom:@"slider_button"];
    [self setThumbImage:thumbImage forState:UIControlStateNormal];
    UIImage *trackImage = [UIManager.i imageNamedCustom:@"slider_track"];
    ...
    [self.decreaseButton setImage:[UIManager.i imageNamedCustom:@"slider_minus"] forState:UIControlStateNormal];
    ...
    [self.increaseButton setImage:[UIManager.i imageNamedCustom:@"slider_plus"] forState:UIControlStateNormal];
