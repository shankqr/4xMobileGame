...
- (void)updateView
{
    ...
    if (self.level < 23)
    {
        if (![rowNx[self.level-1] isEqualToString:@""])
        {
            ...
            NSDictionary *row108 = @{@"r1": NSLocalizedString(@"Castle Info", nil), @"r1_button": @"2", @"c1": NSLocalizedString(@"City Details", nil), @"c1_button": @"2", @"nofooter": @"1"};
